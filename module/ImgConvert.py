...
class ImgConvert:  
    ...
    def calculate_string_height(font_type, font_size, content, max_width, line_multiplier):  
        ...
        for word in words:  
            ...
            test_width, _ = draw.textsize(test_str, font)  
    ...
    def draw_string(image, styled_string, x, y, max_width, line_multiplier):  
        ...
        for line in lines:  
            ...
            text_width, text_height = draw.textsize(line, font=styled_string.font)  
            temp_text = line  
            ...
            while text_width > max_width:  
                ...
                draw_width, _ = draw.textsize(draw_text, font=styled_string.font)  
    ...
    def apply_tint(image, tint):  
        ...
        tinted_image = Image.new("RGBA", (width, height), tint_color)  
    ...
    class StyledString:  
        def __init__(self, content: str, font_type: str, font_size: int, line_multiplier: float = 1.0):  
            ...
            if self.font:  
                image = Image.new('RGB', (ImgConvert.MAX_WIDTH, 100), color=(255, 255, 255))  
                draw = ImageDraw.Draw(image)  
                _, text_height = draw.textsize(content, font=self.font) 
